...
public interface YopsaasKeywordMapper {
     ...
     * @mbg.generated
     */
    YopsaasKeyword selectByPrimaryKeySelective(@Param("id") Integer id, @Param("selective") YopsaasKeyword.Column ... selective);
     ...
     * @mbg.generated
     */
    YopsaasKeyword selectByPrimaryKey(Integer id);
     ...
     * @mbg.generated
     */
    YopsaasKeyword selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id, @Param("andLogicalDeleted") boolean andLogicalDeleted);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(YopsaasKeyword record);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(YopsaasKeyword record);
