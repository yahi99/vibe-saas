...
public class AdminRegionController {
    ...
    public Object list() {
        ...
        List<LitemallRegion> yopsaasRegions = regionService.getAll();
        Map<Byte, List<LitemallRegion>> collect = yopsaasRegions.stream().collect(Collectors.groupingBy(LitemallRegion::getType));
        byte provinceType = 1;
